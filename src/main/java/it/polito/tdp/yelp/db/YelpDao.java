...
public class YelpDao {
	...
	public List<Business> getAllBusinessWithCityAndYear(String citta, int anno){
		String sql = "SELECT b.* "
			       + "FROM Business b, Reviews r "
			       + "WHERE b.business_id = r.business_id AND city = ? AND YEAR(review_date) = ?";
		List<Business> result = new ArrayList<Business>();
		Connection conn = DBConnect.getConnection();
	...
	public double calcolaMediaRecensioniWithLocaleAndAnno(Business locale, int anno){
